    ...
    return (
        <div className="w-full">
            <Image
                ...
                height={300}
                width={300}
                className="fixed bottom-0 left-0 transition-all hidden sm:block sm:w-[30%] -z-10"
            />
            <Image
                src={img2}
                alt="right image"
                height={300}
                width={300}
                className="fixed bottom-0 right-0 transition-all hidden sm:block sm:w-[30%] -z-10"
            />
